...
class AI:
    ...
    def evalState(self, move, turn):
        ...
        if (turn == RED):
            my_king_count = board.red_kings
            enemy_king_count = board.white_kings
            my_piece_count = board.red_left
            enemy_piece_count = board.white_left
        else:
            my_king_count = board.white_kings
            enemy_king_count = board.red_kings
            my_piece_count = board.white_left
            enemy_piece_count = board.red_left
        score = my_piece_count - (enemy_piece_count * 2) + (my_king_count * 3) - (enemy_king_count * 4)
        return score
