...
from game_agent import custom_score_2, custom_score_5
...
def main():
    ...
    test_agents = [
                   ...
                   Agent(CustomPlayer(score_fn=custom_score_2, **CUSTOM_ARGS), "Custom Heuristics 2"),
                   Agent(CustomPlayer(score_fn=custom_score_5, **CUSTOM_ARGS), "Custom Heuristics 5"),
                   ]
