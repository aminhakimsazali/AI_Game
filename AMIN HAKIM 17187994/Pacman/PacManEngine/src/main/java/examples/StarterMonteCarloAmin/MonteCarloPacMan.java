...
import examples.StarterMonteCarloAmin.evaluators.*;
...
public class MonteCarloPacMan extends PacmanController {
...
//        RuleBasedEvaluator evaluator = new RuleBasedEvaluator();
//        evaluator.evaluateTree(tree);
